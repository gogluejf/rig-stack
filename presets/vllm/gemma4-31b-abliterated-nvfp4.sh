...
# Model:  sakamakismile/Huihui-gemma-4-31B-it-abliterated-v2-NVFP4
...
VLLM_ARGS=(
  vllm serve /models/hf/sakamakismile/Huihui-gemma-4-31B-it-abliterated-v2-NVFP4
  --served-model-name sakamakismile/Huihui-gemma-4-31B-it-abliterated-v2-NVFP4
